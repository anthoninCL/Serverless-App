  ...
  return (
    <View>
      ...
      <JText
        ...
        labelKey={"auth.setUpAccountExplanation"}
      />
      ...
      <FormInput
        ...
        placeholderKey={"auth.confirmPassword"}
        style={styles.input}
        secure
      />
      <ViewRow align={"center"} style={{ marginVertical: theme.sizings.sz25 }}>
        <CheckBox
          value={termsAgreed}
          onPress={onTermsCheckboxClicked}
          style={{ marginRight: 15 }}
        />
        <Text style={styles.termsLabel}>
          {t("terms.agreeWith")}
          <Text style={styles.termsLinks}>{t("terms.terms")}</Text>
          {t("terms.and")}
          <Text style={styles.termsLinks}>{t("terms.privacyPolicy")}</Text>
          {t("terms.pleaseAgree")}
        </Text>
      </ViewRow>
      <ClassicButton
