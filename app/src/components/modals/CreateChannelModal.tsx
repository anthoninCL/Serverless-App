    ...
    <Overlay isVisible={props.isVisible} onBackdropPress={props.onBackDropPress} overlayStyle={{borderRadius: 10, maxWidth: 800}}>
      <ViewCol style={{paddingHorizontal: 20, paddingVertical: 20}}>
        <ViewRow align={'center'} justify={'space-between'} style={{width: '100%'}}>
          <Text style={{fontWeight: '900', fontSize: theme.fontSizes.huge}}>Create a channel</Text>
        ...
        <FormInput value={name} onChange={setName} backgroundColor={'white'} placeholderKey={"common.channelName"} style={{marginBottom: 20}}/>
        <ViewRow align={'center'} style={{marginTop: 20}}>
          <Text style={{color: theme.colors.lightHigh, fontSize: 15, paddingRight: 80}}>Before creating your channel, make sure you're not doing any mistake by choosing a wrong name.</Text>
